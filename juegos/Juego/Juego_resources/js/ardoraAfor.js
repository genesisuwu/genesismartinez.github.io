...
function calcMaxWidth(){for (i = 0; i < wordsG.length; i++) {var actualSize=0;actualSize=$.trim(aforWords(wordsG[i])).length*(49+9);
...
function paintbGame(){profG=profG+37+9;var leV=(actMaxWidth-($.trim(aforWords(wordsG[indexG])).length-1)*(37+19))/2;
